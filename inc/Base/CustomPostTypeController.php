...
use Inc\Biblio\Api\Callbacks\CptCallbacks;
  ...
  public function setSettings()
	{
		$args = [
			[
				'option_group'=> 'biblio_cpt_settings',
				'option_name' => 'biblio_cpt',
	...
	public function setSections()
	{
		$args = [
			[
				...
				'page' => 'biblio_cpt' //From menu_slug
				]
		];
