...
class CoversLogListTable extends WP_List_Table {
    ...
    public function __construct() {
        parent::__construct([
            'singular' => 'covers_log',  // Singular label of the table
            'plural'   => 'covers_logs', // Plural label of the table
    ...
    public function prepare_items() {
        ...
        $logTable = $wpdb->prefix . $coversApiDbLogManager::COVERS_LOG_TABLE;
